    ...
    <div className="space-y-6">
      ...
      <div className="card overflow-hidden">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
              {filteredProcesses.slice(0, 100).map((process) => (
                ...
                >
                  <td className="px-4 py-3 font-mono text-primary-500">{process.pid}</td>
                  <td className="px-4 py-3">
                    <div className="max-w-[250px]">
                      <p className="font-medium text-slate-900 dark:text-white truncate">
                        {process.name}
                      </p>
                      <p className="text-xs text-slate-400 truncate" title={process.cmdline}>
        ...
        {filteredProcesses.length > 100 && (
          <div className="px-4 py-3 text-center text-sm text-slate-400 bg-slate-50 dark:bg-slate-800/50">
